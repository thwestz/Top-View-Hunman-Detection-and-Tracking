...
void computeHOGs(const Size wsize, const vector< Mat > & img_lst, vector< Mat > & gradient_lst, bool use_flip)
{
	//HOGDescriptor hog;
	//hog.winSize = wsize;
	HOGDescriptor hog(Size(64, 64), Size(8, 8), Size(8, 8), Size(8, 8), 9, 1, -1, HOGDescriptor::L2Hys, 0.2, false, HOGDescriptor::DEFAULT_NLEVELS, false);
...
int main(int argc, char** argv)
{
	...
	String pos_dir = "D:/Senior_Project/head/crop64x64";
	String neg_dir = "D:/Senior_Project/head/neg_resize64x64";
	String test_dir = "D:/Senior_Project/head/test";
	String obj_det_filename = "D:/Senior_Project/head/20180330-1.xml";
	...
	if (train_twice)
	{
		...
		HOGDescriptor my_hog(Size(64, 64), Size(8, 8), Size(8, 8), Size(8, 8), 9, 1, -1, HOGDescriptor::L2Hys, 0.2, false, HOGDescriptor::DEFAULT_NLEVELS, false);
